...
class getVichUploader_Listener_Remove_RecipeImagesService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.remove.recipe_images'])) {
            return $container->privates['vich_uploader.listener.remove.recipe_images'];
        }

        return $container->privates['vich_uploader.listener.remove.recipe_images'] = new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('recipe_images', ($container->privates['vich_uploader.adapter.orm'] ?? ($container->privates['vich_uploader.adapter.orm'] = new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter())), ($container->privates['vich_uploader.metadata_reader'] ?? $container->getVichUploader_MetadataReaderService()), $a);
    }
}
