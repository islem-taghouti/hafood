...
class __TwigTemplate_3f8663eb731bc5cee09c0b59f079a163063a557a39e8ef36a7da6a0aa2af15bd extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t";
        // line 24
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["recipe"]) || array_key_exists("recipe", $context) ? $context["recipe"] : (function () { throw new RuntimeError('Variable "recipe" does not exist.', 24, $this->source); })()), "average", [], "any", false, false, false, 24), "html", null, true);
        echo "
\t\t\t/5</p>
...
\t\t</div>
\t{% endblock %}
", "pages/recipe/show.html.twig", "C:\\Users\\islem\\Desktop\\recette\\symrecipe\\templates\\pages\\recipe\\show.html.twig");
    }
}
