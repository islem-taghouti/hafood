...
class __TwigTemplate_3c00a6626e7db0b547911ba17924b3a84f1b26323b7a1bc089eb7fba57b33782 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t<input type=\"email\" class=\"form-control\" id=\"username\" name=\"_username\" placeholder=\"exemple@HaFood.fr\" value=\"";
        // line 25
...
\t\t\t<div class=\"form-group\">
\t\t\t\t<label for=\"username\" class=\"form-label mt-4\">Adresse email</label>
\t\t\t\t<input type=\"email\" class=\"form-control\" id=\"username\" name=\"_username\" placeholder=\"exemple@HaFood.fr\" value=\"{{ last_username }}\">
\t\t\t\t<small id=\"emailHelp\" class=\"form-text text-muted\">We'll never share your email with anyone else.</small>
\t\t\t</div>
\t\t\t<div class=\"form-group\">
\t\t\t\t<label for=\"password\" class=\"form-label mt-4\">Mot de passe</label>
